...
document.querySelectorAll(".box").forEach((item) => {
  item.addEventListener("click", function () {
    ...
    if (tog % 2 !== 0) {
      ...
      document.getElementById("tog").style.textAlign = "Left";
      document.getElementById("tog").style.color = "#f0d9b5";
      document.getElementById("tog").style.backgroundColor = "#8b4513";
      whosTurn("W");
    }
    if (tog % 2 == 0) {
      document.getElementById("tog").innerText = "Black's Turn";
      document.getElementById("tog").style.textAlign = "Right";
